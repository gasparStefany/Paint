...
/**
 * Classe de implementação de uma Reta como uma figura Algoritmos de formacao da
 * reta: Reta DDA Reta Bresenham Algoritmo de Manipulação da reta: Translação
 * Rotação Escala
 */
...
public class Reta extends Figura {
    ...
    /**
     * Metodo para desenhar a reta na tela utilizando o algoritmo DDA Fonte: Slides
     * de Computacao Grafica presentes no SGA
     */
    @Override
    ...
    /**
     * Metodo para plotar a figura utilizando o algoritmo de Bresenham Fonte: Slides
     * de Computacao Grafica Presentes no SGA
     */
    @Override
    ...
    /**
     * Metodo para alterar a escala da figura multiplicando cada um dos parametros
     * com o seu ponto final
     * 
    ...
    public void mudarEscalaFigura(double escalaX, double escalaY) {
        try {
            if (!this.isCircunferencia) {
                ...
                Ponto novoPontoFinal = new Ponto(Math.round(this.pontoFinal.x * escalaX),
                        Math.round(this.pontoFinal.y * escalaY));
        ...
        try {
            if (!this.isCircunferencia) {
                if (opcode == 0) {// espelhamento eixo x
                    ...
                    // x' = x
                    // y' = y * -1
                    Ponto novoPontoFinal = new Ponto(Math.round(this.pontoFinal.x + fator * this.pontoFinal.y),
                            this.pontoFinal.y);
                    ...
                    // x' = x
                    // y' = y * -1
                    Ponto novoPontoFinal = new Ponto(this.pontoFinal.x,
                            Math.round(this.pontoFinal.y + fator * this.pontoFinal.x));
    ...
    /**
     * Metodo de chamada para o Algoritmo de CohenSutherland implementado na classe
     * abstrata Figura
     * 
    ...
    /**
     * Metodo de chamada para o Algoritmo de LiangBarksy implementado na classe
     * abstrata Figura
     * 
     * @param img      BufferedImage onde é desenhado cada reta
     * @param pontoMin Ponto minimo da janela de recorte
